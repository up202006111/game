...
public class InstructionsMenuViewer extends Viewer<InstructionsMenu> {
    ...
    protected void drawElements(GUI gui) {
        ...
        if (getModel().isSelectedDiamonds()) {
